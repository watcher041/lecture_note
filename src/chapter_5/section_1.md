...
　振り子の運動というのは、天井から質点を糸で吊るして揺らしたときの運動を指しており、質点の位置を $\boldsymbol{r}$、質量を $\boldsymbol{r},m$ 、外力として糸の張力 $\boldsymbol{T}$、重力 $\boldsymbol{G}$ が働いているとすると運動方程式は

$$
    m\frac{\mathrm{d}^2\boldsymbol{r}}{\mathrm{d}t}=
    \boldsymbol{T}+\boldsymbol{G}
$$
