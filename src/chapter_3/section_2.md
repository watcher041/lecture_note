...
ここで、正負の電荷について**同じ物体内であれば**引力が働きくっつくことから見かけ上電荷が0になり電場も生じないことになる。そのため、通常の場合に物体は同じ正か負の電荷のものだけが存在していることになる（電気振り子の実験からもうかがえる）。ここで電気振り子の場面を改めて考えてみると、一つの物体から電場が発生するともう一つの物体内の点電荷が移動するわけだが、このときその物体内では正と負でそれぞれ別々の力が働くため以下の図のように別れるものと考えられる。この現象は実際に確認できるため、特に**静電誘導**と呼ばれている。このとき誘起された電荷を**誘導電荷**、静電誘導を示す物体を**導体**と呼ぶ。

 <p align="center">
    <img height="150px" src="images/electrostatic_induction.png">
</p>

導体の表面では向かい合わせで正と負の電荷が分布するため、その中でも正から負の電荷に向けて電場が発生し始める。帯電体A上の電荷は、導体の内外を問わず、そのまわりの空間に電場をつくり、その作用により導体表面上に誘導電荷を発生させる。この正負の誘導電荷も導体内で電場を作ることで、導体内では外部と比べて弱くなる。これを繰り返していくと、やがて導体内の電場がなくなったときに静電誘導が止まるものと考えられる。
