...
この法則に従うことで、物体に電荷がない場合や同じ正負の電荷が存在している場合は打ち消して電場が生じないことが言える。

<!-- 

ここで、正負の電荷について**同じ物体内であれば**引力が働きくっつくことから見かけ上電荷が0になり電場も生じないことになる。そのため、通常の場合に物体は同じ正か負の電荷のものだけが存在していることになる（電気振り子の実験からもうかがえる）。ここで電気振り子の場面を改めて考えてみると、一つの物体から電場が発生するともう一つの物体内の点電荷が移動するわけだが、このときその物体内では正と負でそれぞれ別々の力が働くため以下の図のように別れるものと考えられる。このとき、帯電体Aの電荷が正負どちらでも引力が働くことになり、実際接触するまでに引力が働くことが確認できる。この現象は特に**静電誘導**と呼ばれており、このとき誘起された電荷を**誘導電荷**と呼ぶ。
...
　この考えで物体内に電場がなくなることから、電場の影響をうけないようにすることを**静電遮蔽**と呼ばれている。ところが、この現象は金属などでは示すがプラスチックなどでは示さずわずかに電場が弱くなるだけにとどまる。


このように、物体内にある点電荷の分布によって物体から生じている電場が分かるわけだが、現在では物質を構成している原子が点電荷の役割を担っていることが知られている。具合的には、正に帯電した重い原子核（電荷をもたない中性子と正に帯電した陽子から構成されているもの）とその周囲に分布する負に帯電した電子からできており、電子と陽子の電荷の大きさは正確に等しい。簡単な例として水素の場合だと以下の図の通りになる（電子の数は原子番号に相当する）。

<p align="center">
    <img height = "150px" src="images/hydrogen_pm.png">
    <img height = "150px" src="images/hydrogen.png">
</p>

ここで、原子核に対して電子が安定して束縛されているような状況だと自由に移動ができずに電荷の移動も起きにくい。このような物体を**絶縁体**と呼ぶ。

<p align="center">
    <img height = "100px" src="images/nonconductor.png">
</p>

一方で、電子の束縛が不安定な場合だと自由に移動が起こり電荷の移動も起きやすくなる。このような物体を**導体**と呼ぶ。
