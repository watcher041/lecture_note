...
$$
というように短く感じることになる。このように、KからK'の立場でみたときに動いている対象の時間の進み方が遅れているように見えてしまう（時間の遅れ）ことが分かる。
先ほどの式は時刻0から時間を計測しており $\Delta t = t_{\rm C}$ となるため、この事象によるものとなっている。

### Lorentz収縮
　次に2点ABで上記と同様に時間を計測すると、その2点間において
$$
...
$$
このことから、まず片方で同時に測ったとしてももう片方が同じ立場で見たときはそうではなく $v/c^2 L$ だけ差異があり、しかもその関係で測った長さも短く見えてしまうことになる。 