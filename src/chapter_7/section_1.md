...
というように満たすことが分かる。一方で、地点 B での関係式は満たしていないことも確認できる。

$$
     x'^2_B+y'^2_B+z'^2_B=(ct'_B)^2、
    x^2_B+y^2_B+z^2_B=(ct_B)^2
$$

ここで地点 C については成立していることと時間 $t'$ が $x'$ と同じような形（ $x,t$ の一次関数）となっていることから

$$
    x'=ax+bt、y'=y、z'=z、t'=dx+et　（a、b、d、e：定数）
$$
