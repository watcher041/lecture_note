...
$$
    p_1^2=2m U
$$
として、これを満たす $q_1,p_1$ の状態数（組み合わせの数）を数えていく。今の場合、一辺 $L$ の箱の中に粒子があることを考えると、無限にあるが一旦 $\Delta q、\Delta p$ ごとに一つの状態が観測される（観測する間隔を定める）ものとして
$$
    \mathcal{W}=
    \frac{L}{\Delta q}\times
    2
...
$$
    ...
    V=L^3
$$
ここで、後に $\Delta q、\Delta p$ は $0$ とすることを踏まえると、
$$
    \Delta q\Delta p = h
$$ 
