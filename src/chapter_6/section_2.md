...
　気体の性質を調べる際には、よくピストンなどの容器に気体を閉じ込めておくことが多いが、このときに閉じ込められた気体（分子の集まり）は一種の集団を形成している。この集団を**統計集団**と呼ぶ。例えば、この気体が外部との熱のやり取り、漏れ出しなどもなく完全に孤立している集団（**小正準集団**）だとすると、外部との熱 $\mathrm{d}'Q$ と気体が行う仕事 $\mathrm{d}W$ はそれぞれ0となる（容器の体積が変化しないことから仕事も0）。そのため、内部エネルギーの変化量 $\mathrm{d}U$ は熱力学第一法則により
