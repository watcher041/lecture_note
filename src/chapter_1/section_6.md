...
しかし、これらは物体の変形を考慮されておらず**変形しない物体にしか適用されない**ものとなっている。そのため、この二つの式のみ従う物体はよく**剛体**（変形しない物体）と呼ばれている。また、変形しないというのは重心からの質点の位置が変化しないということであるため、以下の関係が成りたつことになる。
...
このことから、回転の速度ベクトルは位置ベクトルと直交した方向を向いていることが分かる。
