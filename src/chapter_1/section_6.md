...
<p align="center">
    <img width="30%"  
        ...
        src="images/cm10-1.jpg">
    　　　
    <img width="22.5%"  
        style="background-color:white;"
        src="images/cm10-2.jpg">
</p>

例えば、棒を糸でつるした状態を考えると、振り子の状態になる。


運動方程式としては重心にかかる重力と張力がつりあうことで静止しているものと思われる。実際、運動方程式においても
...
となる。ところが、糸を吊るす場所によっては同じ運動方程式が成り立っても棒が揺れて（回転して）から静止するという事象が起こってしまう。これについては、物体の重心以外に吊したときに起きることで、力とは別に回転の作用が働いたことで回転したものと思われる。回転自体は糸と棒のつなぎ目を中心に起きており、静止する地点というのは力が互いに水平になるところであることも推測できる。
